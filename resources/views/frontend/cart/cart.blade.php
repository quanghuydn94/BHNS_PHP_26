...
<div class="cart_main_area ">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <form action="#">
                    <div class="table-content table-responsive" id="cart_table">
                                        ...
                                        <div class="quickview_plus_minus quick_cart">
                                            <div class="quickview_plus_minus_inner">
                                                <div class="cart-plus-minus cart_page">
                                                    <input type="number" min="1" value="{{ $cart['quantity'] }}" class="form-control quantity " />
                                                </div>
                                            </div>
                                        </div>
                                    </td>
    ...
    function cartUpdate(e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // $(".cart_main_area").load(".cart_main_area");
